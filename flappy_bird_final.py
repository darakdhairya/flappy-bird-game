...
def draw_bird():
    """
    Draw a simple but recognizable bird: oval body, a lighter wing,
    a white eye with a black pupil, and an orange triangular beak.
    Drawn onto its own small transparent surface first so the whole
    bird can be rotated together based on velocity.
    """
    size = bird_radius * 3
